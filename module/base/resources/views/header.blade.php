    ...
    <nav class="navbar navbar-expand">
        <div class="left-topbar d-flex align-items-center">
            ...
            <div class="logo-white">
                <img src="{{asset('admin/assets/images')}}/logo-white.png" class="logo-icon" alt="">
            </div>
            <div class="logo-dark">
                <img src="{{asset('admin/assets/images')}}/logo-dark.png" class="logo-icon" alt="">
            </div>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-user-profile">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">	<a class="dropdown-item" href="javaScript:;"><i
                        ...
                        <div class="dropdown-divider mb-0"></div>	<a class="dropdown-item" href="{{route('wadmin::auth.logout.get')}}"><i
