            ...
            <!--breadcrumb-->
                    ...
                    <div class="pl-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{route('wadmin::users.index.get')}}">Quay lại danh sách<i class="bx bx-home-alt"></i></a>
                                </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">Nhập thông tin để sủa tài khoản</div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control">
                                            ...
                                            <option value="disabled" {!! ($data->status=='disabled') ? 'selected' : '' !!} >Tạm khóa</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control">
                                            ...
                                            @foreach($roles as $r)
                                                <option value="{{$r->id}}" {!! ($currentRole == $r->id) ? 'selected' : '' !!} >{{$r->display_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
